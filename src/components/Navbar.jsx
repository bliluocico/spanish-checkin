...
export default function Navbar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 flex justify-center safe-bottom">
      <div className="bg-white/80 backdrop-blur-xl border-t border-[#FFE8D0]/50 shadow-[0_-4px_20px_rgba(255,123,123,0.08)] rounded-t-3xl px-6 py-2 flex gap-4 max-w-[480px] w-full justify-center">
